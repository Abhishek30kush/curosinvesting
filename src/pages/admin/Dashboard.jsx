...
import { FileText, Users, Eye, TrendingUp, Clock, Edit3 } from 'lucide-react';
import { useAuth } from '../../lib/auth-context';

export const Dashboard = () => {
  const [stats, setStats] = useState({ articles: 0, views: 0, pending: 0, drafts: 0, writers: 0 });
  const { user } = useAuth();
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="glass-card p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-slate-400 font-medium">Total Articles</h3>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-slate-400 font-medium">Pending Review</h3>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-slate-400 font-medium">Drafts</h3>
